        ...
        >
          {searchData ? (
            ...
            <div className="w-full h-full mt-8 flex justify-center items-center">
              <div
                className="w-8 h-8 flex border-4 border-red-600 rounded-full border-b-red-300 animate-spin"
                role="status"
              />
      ...
      <div className="flex">
        <span className="flex shadow-md rounded-lg">
          ...
          >
            ...
            <option className="text-gray-600" value={"jpy"}>
              JPY
            </option>
            <option className="text-gray-600" value={"aud"}>
              AUD
            </option>
            <option className="text-gray-600" value={"nzd"}>
              NZD
            </option>
            <option className="text-gray-600" value={"cad"}>
              CAD
            </option>
            <option className="text-gray-600" value={"gbp"}>
              GBP
            </option>
          </select>
          <img
